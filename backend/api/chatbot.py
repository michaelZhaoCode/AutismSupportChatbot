...
class Chatbot:
    ...
    def chat(self, prompt: str, username: str, usertype: str, location: str = "", region_id: int = -1, enable_web_search: bool = False) -> dict:
        """
        ...
        Args:
            ...
            enable_web_search (bool, optional): Whether to enable web search to enhance responses. Defaults to False.

        Returns:
            dict: The chat response generated by the BotService with web search results if enabled.
        """
